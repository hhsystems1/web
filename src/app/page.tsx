...
export default function Home() {
  ...
  const whyChooseUs = [
    ...
    },
    {
      ...
      stat: "Real-Time Data",
      description: "Every website includes a dashboard to track visitors, leads, and conversions."
    }
  ];
  ...
  const demos = [
    {
      ...
      description: "See how a restaurant website can showcase your menu, take reservations, and build a loyal customer base.",
      features: ["Online menu & ordering", "Reservation booking", "Customer reviews", "Photo gallery"],
      href: "/demos/restaurant"
    },
    {
      industry: "contractor" as const,
      title: "Contractor & Home Services",
      description: "Discover how a contractor site can generate quote requests, showcase projects, and grow your service area.",
      features: ["Quote request forms", "Project gallery", "Service area map", "Before & after showcase"],
      href: "/demos/contractor"
    },
    {
      industry: "medical" as const,
      title: "Medical & Dental Office",
      description: "Explore how a medical practice website can streamline appointments, build patient trust, and reduce no-shows.",
      features: ["Appointment booking", "Provider profiles", "Insurance info", "Patient FAQ"],
      href: "/demos/medical"
    }
  ];
      ...
      <Section className="bg-gradient-to-b from-[#faf8f5] via-white to-gray-50">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:items-stretch">
          <motion.div
            ...
            className="rounded-2xl border border-red-200/50 bg-red-50/50 p-8 shadow-xl shadow-red-100/20 backdrop-blur-xl"
          >
          ...
          <motion.div
            ...
            className="rounded-2xl border border-emerald-200/50 bg-emerald-50/50 p-8 shadow-xl shadow-emerald-100/20 backdrop-blur-xl"
          >
      ...
      <Section className="bg-gradient-to-b from-gray-50 via-white to-gray-50">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          <motion.p
            ...
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6 }}
            className="mb-4 text-sm font-semibold uppercase tracking-[0.2em] text-emerald-600"
          >
          ...
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold text-gray-900 mb-6"
          >
            From demo to your live website
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
          {funnelSteps.map((step, index) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-gray-200/60 bg-white/60 p-6 shadow-xl shadow-gray-100/20 backdrop-blur-xl"
            >
              <div className="mb-5 inline-flex h-12 w-12 items-center justify-center rounded-full bg-gradient-to-r from-emerald-500 to-blue-400 text-lg font-bold text-white">
                {index + 1}
              </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 max-w-3xl">
            ...
            <motion.p
              ...
              className="text-xl text-gray-500 leading-relaxed"
            >
              Interact with real website demos built for your industry. Click through, test the booking flows, and see what your business could look like.
            </motion.p>
          </div>
        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[0.85fr_1.15fr] lg:items-center">
          <div>
            ...
            <motion.p
              ...
              className="text-xl text-gray-500 leading-relaxed"
            >
              Your site can collect leads, book time, answer common questions, and track every visitor through your analytics dashboard.
            </motion.p>
          </div>
            ...
            {[
              {
                ...
                points: ["Website inquiry forms", "Quote request flows", "Owner-ready lead handoffs"]
              },
              {
              ...
              {
                title: "Analytics dashboard included",
                description: "Track page views, form submissions, bookings, and conversions — all in one clean dashboard.",
                points: ["Visitor tracking", "Conversion funnel", "Lead source analytics"]
              }
            ].map((highlight, index) => (
              <motion.div
                key={highlight.title}
                ...
                className="rounded-lg border border-gray-200/60 bg-white/60 p-6 shadow-xl shadow-gray-100/20 backdrop-blur-xl"
              >
      ...
      <Section className="bg-gradient-to-b from-gray-50 to-white">
        <div className="text-center mb-16">
          ...
          <motion.p
            ...
            className="text-xl text-gray-500 max-w-3xl mx-auto"
          >
            We build websites that make follow-through easier to manage — with a dashboard to prove it.
          </motion.p>
        </div>
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Try a live demo, then customize it with your branding. Your new website is just a few clicks away.
            </p>
            <Link
              href="/#demos"
