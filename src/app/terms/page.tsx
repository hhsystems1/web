        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="space-y-10 text-gray-700">
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">1) Services; accounts; scope</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">3) Subscriptions, billing, and cancellations</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">4) Project workflow; deliverables; acceptance</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">5) Revisions; change requests</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">6) Maintenance and support</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">7) Third‑party services and licenses</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">8) Intellectual property</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">9) Confidentiality</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">10) AI‑assisted work</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">11) Compliance; accessibility; SEO</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">12) Warranties; disclaimers</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">13) Limitation of liability</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">14) Indemnification</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">15) Termination; effect</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">16) Governing law; venue; disputes</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">17) Notices; assignment; entire agreement</h2>
              ...
              <section>
                <h2 className="text-3xl font-semibold text-gray-900 mb-4">18) Contact</h2>
                <div className="bg-gray-100 p-6 rounded-lg border border-gray-200 mt-4">
