      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          <button type="submit" disabled={submitting}
            className="inline-flex items-center justify-center px-8 py-4 text-base font-semibold text-white bg-gradient-to-r from-emerald-500 via-emerald-500 to-blue-400 rounded-full hover:shadow-2xl hover:shadow-emerald-300/30 transition-all duration-300 border border-emerald-400/30 hover:border-emerald-400/60 disabled:opacity-60 disabled:cursor-not-allowed">
